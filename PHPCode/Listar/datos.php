        ...
        if($res->rowCount()){
            while ($row = $res->fetch(PDO::FETCH_ASSOC)){
                ...
                $item=array(
                    ...
                    //---------
					//'id'=> (int)$row['id'],//se repite en id
                    'longitud'=> (double)$row['longitud'],
					'paso'=> (int)$row['paso'],
					'dibujar'=> (int)$row['dibujar'],
				    //--------
					//'idDucto'=> (int)$row['idDucto'],//se repite en id
                    'tipo'=> (int)$row['tipo'],
					'nombre'=> $row['nombre'],
        ...
        if($res->rowCount()){
            while ($row = $res->fetch(PDO::FETCH_ASSOC)){
                ...
                $item=array(
					...
					'ccz'=> (float)$row['ccz'],
					//------
                    //'idEquipoV'=> (int)$row['idEquipoV'],// se repite en id
        ...
        if($res->rowCount()){
            while ($row = $res->fetch(PDO::FETCH_ASSOC)){
                ...
                $item=array(
					...
					'conexion'=>(int)$row['conexion'],
                    //---------
					//'id'=> (int)$row['id'],//no se utiliza por que se repite en idItem
					'nombre'=> $row['nombre'],
					'cfm'=> (double)$row['cfm'],
					'estado'=> false, // extra
                );
